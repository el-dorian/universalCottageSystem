...
class SetMembershipTariffModel extends Model
{
    ...
    public function validateData($attribute): void
    {
        ...
        foreach ($data as $key => $value) {
            ...
            if(BasePreferences::getInstance()->membershipPaymentType === BasePreferences::STATE_PAY_YEARLY){
                ...
                if(DbTariffMembership::find()->where(['period' => $value['period']])->count() > 0){
                ...
                if(DbTariffMembership::find()->where(['period' => $value['period']])->count()){
