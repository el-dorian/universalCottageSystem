...
/* @var $this View */
/* @var $model SetTargetTariffModel */

echo '<div class="col-sm-12">';

try {
    $form = ActiveForm::begin(['id' => 't_form', 'options' => ['class' => 'form-horizontal bg-default'], 'enableAjaxValidation' => true, 'action' => ['/form/set-targets']]);
